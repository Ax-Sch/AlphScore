...
#data/{pdb_name}_combined_features.csv.gz
class testclass:
	def __init__(self):
		self.wildcards=["AF-A0A087WUL8-F11-model_v1"]
		self.output=["data/AF-A0A087WUL8-F11-model_v1_features.tsvneighbour_vals.csv"]
		self.input=["data/AF-A0A087WUL8-F11-model_v1__combined_features.csv.gz"]
		self.params=["/media/axel/Dateien/Arbeit_Gen/alphafold2/dbnsfp_data/"]
