...
#testing:
#args[1]<-"/media/axel/Dateien/Arbeit_Gen/alphafold2/dbnsfp_results/Q8NGP4.csv.gz"
#args[2]<-"/media/axel/Dateien/Arbeit_Gen/alphafold2/extract_features_alphafold/results/AF-Q8NGP4-F1-model_v1_features.tsvneighbour_vals.csv"
