...
option_list = list(
  make_option(c("-v", "--variants"), type="character", default="results/prediction/pre_final_model_variants.csv.gz", 
              help="Validation set"),
  make_option(c("-c", "--colnames_to_use"), type="character", default="results/prediction/pre_final_model_colnames_to_use.RData", 
              help="Output folder"),
  make_option(c("-o", "--out_folder"), type="character", default="results/feature_diff_gnomad", 
              help="Output folder")
)
