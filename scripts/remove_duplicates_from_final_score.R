...
option_list = list(
  make_option(c("-v", "--dup_vars"), type="character", default="data/merge_final/all_possible_values_dups.csv.gz", 
              help="list of duplicated variants, final set"),
  make_option(c("-o", "--out_file"), type="character", default="data/merge_final/deduplicated_vars_bind.tsv", 
