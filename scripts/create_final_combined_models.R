...
option_list = list(
  make_option(c("-t", "--training_dataset"), type="character", default="data/prediction_final/pre_final_model_regular_variants.csv.gz", 
  ...
  make_option(c("-i", "--training_var_ids"), type="character", default="data/prediction_final/training_var_ids.tsv", 
